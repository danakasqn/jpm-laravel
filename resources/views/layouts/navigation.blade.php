...
{{-- Finanse --}}
@php $finanseOpen = request()->routeIs('finanse.*') || request()->is('finanse*'); @endphp
<li class="nav-item">
...
{{-- Cykliczne --}}
@php $cykliczneOpen = request()->routeIs('cyclic-finances.*') || request()->is('cyclic-finances*'); @endphp
<li class="nav-item">
    <a class="nav-link d-flex align-items-center justify-content-between"
...
{{-- Ustawienia --}}
@php $ustawieniaOpen = request()->routeIs('settings.*') || request()->is('ustawienia*'); @endphp
<li class="nav-item">
    <a class="nav-link d-flex align-items-center justify-content-between"
